...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # Some class may override send to do something else that's totally different
    # than Object's send. Having __send__ ensures that the function can still
    # call Object's send functionality by calling __send__
  end
